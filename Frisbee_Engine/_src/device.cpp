...
namespace fengine {
    ...
    Device::Device(FWindow& window) : window{ window } {
        createInstance();
        setupDebugMessenger();
        createSurface();
        pickPhysicalDevice();
    ...
    void Device::createInstance() {
        ...
        appInfo.pApplicationName = "FrisbeeEngine";
    ...
    void Device::pickPhysicalDevice() {
        ...
        for (const auto& device : devices) {
            ...
            if (isDeviceSuitable(device)) {
                ...
                // score == 1000 if discrete
                // score == 0 if integrated
                VkPhysicalDeviceProperties deviceProperties;
                vkGetPhysicalDeviceProperties(device, &deviceProperties);
                score += deviceProperties.deviceType == VK_PHYSICAL_DEVICE_TYPE_DISCRETE_GPU ? 1000 : 0;
                std::cout << "score: " << score << " " << deviceProperties.deviceName << std::endl;
    ...
    bool Device::isDeviceSuitable(VkPhysicalDevice device) {
        ...
        return indices.isComplete() 
            ...
            && supportedFeatures.fillModeNonSolid; // Wireframe
    }
